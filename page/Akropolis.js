...
function findWasmBinary() {
  return locateFile('Akropolis.wasm');
}
...
var ASM_CONSTS = {
  84292: () => { if (typeof Module !== 'undefined' && typeof Module.cleanTTY === 'function') { Module.cleanTTY(); } },  
 84395: () => { if (typeof FS !== 'undefined' && FS.stream_ops && FS.stream_ops.tty) { FS.stream_ops.tty.read = function() { return 0; }; } },  
 84523: ($0, $1, $2) => { if (typeof window.term !== 'undefined') { var charToWrite = String.fromCharCode($0); window.term.write("\x1b[s"); window.term.write("\x1b[" + ($2 + 1) + ";" + ($1 + 1) + "H"); if (charToWrite === "\b") { window.term.write("\b \b"); } else { window.term.write(charToWrite); } window.term.write("\x1b[u"); } }
};
